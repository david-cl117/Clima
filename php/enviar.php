<?php
    ...
    //echo "Se conecto a la base de datos correctamente!";
        ...
        if (isset($_SESSION['id'])){
            ...
            $sql = mysqli_prepare($conn, "INSERT INTO chats (texto, usuarioP, usuarioT, usuarioA, transmisor) VALUES (?, ?, ?, ?, ?)");
            mysqli_stmt_bind_param($sql, 'sssss', $texto, $usuarioP, $usuarioT, $usuarioA, $transmisor);
