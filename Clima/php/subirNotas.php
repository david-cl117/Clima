    ...
    //echo "Se conecto a la base de datos correctamente!";
        ...
        if (isset($_SESSION['id'])){
           ...
           if (isset($_FILES['userfile'])){
                ...
                $targetfolder = $_SERVER["DOCUMENT_ROOT"] . $destino . basename($_FILES["userfile"]["name"]);
                //formato del archivo.
                ...
                //validar que el archivo es pdf o word
                if($type == "application/pdf" || $type == "application/msword" || $type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document"){
                    ...
                    if (move_uploaded_file($_FILES["userfile"]["tmp_name"], $targetfolder)){
                        ...
                        $sql = "INSERT INTO notas (nombre_Nota, link, id_alumno) VALUES ('$filename', '$destino', '$idAlumno')";
